                ...
                <div class="card" style="margin-top: 25px; margin-bottom: 25px;">
                    <div class="card-header">
                        ...
                        <div class="row" style="float: right;margin-right: -50px;">
                            <div class="col-lg-4">
                                <form class="form-inline" method="post" action="{{route('admin.reservations.confirm', [$reservation->id])}}">
                                    <input type="submit" class="form-control btn btn-sm btn-success" value="Potvrdit">
                                    {{ csrf_field() }}
                                </form>
                            </div>
                            <div class="col-lg-4">
                                <form class="form-inline" method="post" action="{{route('admin.reservations.deny', [$reservation->id])}}">
                                    <input type="submit" class="form-control btn btn-sm btn-danger" value="Zamítnout">
                                    {{ csrf_field() }}
                                </form>
                            </div>
                        </div>
                ...
                <div class="card" style="margin-top: 25px; margin-bottom: 25px;">
                    <div class="card-header">
                        ...
                        <div class="row" style="float: right;">
                            <div class="col-lg-4">
                                @if ($reservation->status == 'Zamítnuta' or $reservation->status == 'Stornována')
                                <h4><span class="badge badge-secondary">{{$reservation->status}}</span></h4>
                                @else
                                <form class="form-inline" method="post" action="{{route('admin.reservations.storno', [$reservation->id])}}">
                                    <input type="submit" class="form-control btn btn-sm btn-danger" value="Stornovat">
                                    {{ csrf_field() }}
                                </form>
                                @endif
                            </div>
